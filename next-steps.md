...
#### Database connections for `project-client-mern`

- `AZURE_COSMOS_MONGODB_CONNECTION_STRING` environment variable is configured in [project-client-mern.bicep](./infra/app/project-client-mern.bicep) to connect to the MongoDB database. Modify this variable to match your application's needs.
...
- [app/project-client-mern.bicep](./infra/app/project-client-mern.bicep) - Azure Container Apps resources to host the 'project-client-mern' service.
- [app/db-cosmos.bicep](./infra/app/db-cosmos.bicep) - Azure Cosmos DB (MongoDB) to host the 'MongoDB' database.
